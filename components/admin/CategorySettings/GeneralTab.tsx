        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <p className="mt-1 text-xs text-gray-500">
              Available variables: {'{num}'}, {'{id}'}, {'{username}'}. Алиас категории (используется независимо от источника интеграции)
            </p>
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">
            ...
            <select
              value={category.mentionRole || ''}
              onChange={(e) => handleChange('mentionRole', e.target.value)}
              className="w-full px-3 py-2 bg-gray-50 border-0 rounded-md text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500"
            >
            ...
            <p className="mt-1 text-xs text-gray-500">
              Роль для упоминания при создании тикета (используется независимо от источника интеграции)
            </p>
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">
            ...
            />
            <p className="mt-1 text-xs text-gray-500">
              Максимальное количество открытых тикетов на пользователя для этой категории (используется независимо от источника интеграции)
            </p>
          </div>
        </div>
      </div>
